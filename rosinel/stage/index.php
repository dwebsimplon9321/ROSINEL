...
<head>
    ...
    <link rel="stylesheet" href="/stage/css/index.css">
</head>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 style="margin-top: 50px;">Vous voulez développez la visibilité de votre entreprise sur le web grâce au référencement automatique ?</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <a href="https://chalandiz.shop.gp/stage/formulaire/formulaire.php" type="button" class="btn btn-primary" style="width:220px">Commencer</a>
