        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <form method="post" action="register.php">
                    ...
                    <h2>Quelles sont les coordonnée de l'entreprise ?</h2>
                    ...
                    <h2>Une entreprise peut avoir plusieurs catégories veuillez confirmer si vous appartenez à l'une des catégories suivante:</h2>
                    ...
                    <h2>Sélectioner la durée de votre opération:</h2>
