        ...
        <div class="container-fluid Page2" alt="Page2" id="p2">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="form-text"><input type="text" class="form-control frm nonom" name="nom" placeholder="Nom" value="<?php echo $nom; ?>" id="nomId">
                    ...
                    <div class="bout"><input class="btnP" type="button" value="Précedent" id="Del2">
                        ...
                        <button class="btnS" type="submit" name="Suivant" value="suivant" id="Addp3">Suivant</button>
                    </div>-->
        ...
        <div class="container-fluid Page3" alt="Page3" id="p3">
            ...
            <div class="row">
                ...
                <div class="col frm">
                    ...
                    <input type="text" class="form-control frm nonom" name="nom" placeholder="Nom de la fiche GMB" id="nomGmbId">
                    <p class="inf"><abbr title="Entrez le nom exact de votre fiche Google My Business" tabindex="0">?</abbr></p>




                    <input type="text" class="form-control" name="email" placeholder="Email GMB" id="emailGmbId">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="bout">
                                ...
                                <button class="btnS" type="submit" class="btn" name="reg_user">Register</button>
                            </div>
