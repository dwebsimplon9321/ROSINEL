...
<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo PATH; ?>https://projet-filrouge.com.gp/assets/img/favicon.png" rel="icon">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              <img src="/assets/img/logoAAPME.png" alt="" style="width: 50%;">
                  ...
                  <form action="validation.php" method="POST" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="frmEmail" class="form-control" id="email">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="frmPasse" class="form-control" id="yourPassword" required>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Vous n'avez pas de compte?<a href="pages-register.php"> Cr̩er un compte</a></p>
                    </div>
                  </form>
