                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="validation.php" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="frmPrenom" class="form-control" id="prenom" required>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Indiquer un mot de passe de 10 caractères !!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Avez-vous un compte ? <a href="index.php">Connexion</a></p>
                    </div>
                  </form>
