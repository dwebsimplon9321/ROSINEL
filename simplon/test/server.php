...
if (isset($_POST['reg_user'])) {
  ...
  empty($_POST['cat']) ? true : array_push($errors, "Vous devez selectionner la catégorie de l'entreprise");
  ...
  if (count($errors) == 0) {
    ...
    $queryEnt = "INSERT INTO entreprise (ent_id, postale, cat, nomGmb, emailGmb) 
